...
isForwarded: true, 
	...
	thumbnailUrl: "https://telegra.ph/file/ad8db137698c59700e103.jpg",
...
let me = m.sender
let anu = "https://telegra.ph/file/ad8db137698c59700e103.jpg";
...
*Selamat Datang Di Queen Elisa BOT*
...
Terima kasih telah menggunakan layanan kami, syarat ketentuan dan kebijakan privacy berlaku!! 
 `
  await sleep(1000)
...
let niu = [
"https://telegra.ph/file/ad8db137698c59700e103.jpg" ]
const menunya = `
Halo ${pushname}
Saya adalah Queen Elisa yaitu Bot WhatsApp Multi Device. Ada yang bisa elisa bantu? elisa sangat senang bila bisa membantu kamu semua. Untuk menampilkan fitur elisa ketik saja *.allmenu* jangan spam elisa yah, tolong kerja samanya. Terima Kasih`
ehz.sendMessage(m.chat, {
    react: {
      text: '🔁',
      key: m.key,
...
break
   case 'allmenu':{
if (!isGroup) return onlyGroup()
let hoshino = [ "https://telegra.ph/file/ad8db137698c59700e103.jpg","https://telegra.ph/file/ad8db137698c59700e103.jpg" ]
...
ehz.sendMessage(6281316643491 + "@s.whatsapp.net",{image: { url: `https://telegra.ph/file/df778c74a8f0417235acf.jpg`}, caption: text12, mentionedJid:[sender], quoted: ftoko })
}
break
case 'accerror': {
...
await ehz.sendImageAsSticker(m.sender, agg.result.sticker[ki], ftoko, { packname: "©Sticker", author: "Created By Queen Elisa BOT" })
} }
 break
 case 'sc': case 'script':{
...
ehz.sendMessage(from, {image: {url: res[0].media.url}}, {quoted:ftoko})
}
break
        case 'ttpoto':{
...
previewType:"PHOTO", 
thumbnail:`https://telegra.ph/file/ad8db137698c59700e103.jpg`,
sourceUrl:`https://whatsapp.com/channel/0029VaF6yhIGzzKKdBoMCu1Z`
...
case 'pornhub':
		...
		case 'wallgravity':
			...
			setReply(mess.wait)
			ehz.sendMessage(m.chat, { image: { url: `https://api.lolhuman.xyz/api/textprome2/${command}?apikey=${api.Lol}&text1=${args[0]}&text2=${args[1]}`}, caption: `© Elisa Botz\n\n Type: ${command}`})
			break
case 'blackpink':
		case 'neon':
		case 'greenneon':
...
ehz.sendMessage(owner + "@s.whatsapp.net",{image: { url: `https://telegra.ph/file/df778c74a8f0417235acf.jpg`}, caption: text12, mentionedJid:[sender], quoted: ftoko })
}
break
case 'accpesanan': {
if (!isOwner && !isAdmins) return setReply()
